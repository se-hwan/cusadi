...
extern "C" void cu_assign_const(float *out, const int col_out, const int sz_out,
                                const float in,
                                const int batch_size) {
...
extern "C" void cu_assign(float *out, const int col_out, const int sz_out,
...
extern "C" void cu_neg(float *out, const int col_out, const int sz_out,
                          const float *in, const int col_in, const int sz_in,
                          const int batch_size) {
    int blockSize = 512; // This can be tuned for performance
    int gridSize = (batch_size + blockSize - 1) / blockSize;
...
extern "C" void cu_add(float *out, const int col_out, const int sz_out,
...
extern "C" void cu_sub(float *out, const int col_out, const int sz_out,
                       const float *in1, const int col_in1, const int sz_in1,
                       const float *in2, const int col_in2, const int sz_in2,
                       const int batch_size) {
    int blockSize = 512; // This can be tuned for performance
...
extern "C" void cu_mul(float *out, const int col_out, const int sz_out,
                       const float *in1, const int col_in1, const int sz_in1,
                       const float *in2, const int col_in2, const int sz_in2,
                       const int batch_size) {
    int blockSize = 512; // This can be tuned for performance
...
extern "C" void cu_div(float *out, const int col_out, const int sz_out,
                       const float *in1, const int col_in1, const int sz_in1,
                       const float *in2, const int col_in2, const int sz_in2,
                       const int batch_size) {
    int blockSize = 512; // This can be tuned for performance
...
extern "C" void cu_exp(float *out, const int col_out, const int sz_out,
                       const float *in, const int col_in, const int sz_in,
                       const int batch_size) {
    int blockSize = 512; // This can be tuned for performance
    int gridSize = (batch_size + blockSize - 1) / blockSize;
...
extern "C" void cu_log(float *out, const int col_out, const int sz_out,
                       const float *in, const int col_in, const int sz_in,
                       const int batch_size) {
    int blockSize = 512; // This can be tuned for performance
    int gridSize = (batch_size + blockSize - 1) / blockSize;
...
extern "C" void cu_sqrt(float *out, const int col_out, const int sz_out,
                        const float *in, const int col_in, const int sz_in,
                        const int batch_size) {
    int blockSize = 512; // This can be tuned for performance
    int gridSize = (batch_size + blockSize - 1) / blockSize;
...
extern "C" void cu_sq(float *out, const int col_out, const int sz_out,
                      const float *in, const int col_in, const int sz_in,
                      const int batch_size) {
    int blockSize = 512; // This can be tuned for performance
    int gridSize = (batch_size + blockSize - 1) / blockSize;
...
extern "C" void cu_sin(float *out, const int col_out, const int sz_out,
                       const float *in, const int col_in, const int sz_in,
                       const int batch_size) {
    int blockSize = 512; // This can be tuned for performance
    int gridSize = (batch_size + blockSize - 1) / blockSize;
...
extern "C" void cu_cos(float *out, const int col_out, const int sz_out,
                       const float *in, const int col_in, const int sz_in,
                       const int batch_size) {
    int blockSize = 512; // This can be tuned for performance
    int gridSize = (batch_size + blockSize - 1) / blockSize;
...
extern "C" void cu_tan(float *out, const int col_out, const int sz_out,
                       const float *in, const int col_in, const int sz_in,
                       const int batch_size) {
    int blockSize = 512; // This can be tuned for performance
    int gridSize = (batch_size + blockSize - 1) / blockSize;
