...
# codegen_strings["input_idx"] = f"\n__constant__ int input_idx[] = {{{','.join(map(str, input_idx))}}};"
# codegen_strings["input_idx_lengths"] = f"\n__constant__ int input_idx_lengths[] = {{{','.join(map(str, input_idx_lengths))}}};"
# codegen_strings["output_idx"] = f"\n__constant__ int output_idx[] = {{{','.join(map(str, output_idx))}}};"
# codegen_strings["output_idx_lengths"] = f"\n__constant__ int output_idx_lengths[] = {{{','.join(map(str, output_idx_lengths))}}};"
# codegen_strings["operations"] = f"\n__constant__ int operations[] = {{{','.join(map(str, operations))}}};"
# codegen_strings["const_instr"] = f"\n__constant__ double const_instr[] = {{{','.join(map(str, const_instr))}}};"
